...
namespace API.Controllers
{
    public class ProgramacionController : BaseController
    {
        ...
        [HttpGet]
        public async Task<IEnumerable<ProgramacionDto>> GetProgramaciones()
        {
            var result = await _unitOfWork.Programaciones.GetAllAsync();
            return _mapper.Map<IEnumerable<ProgramacionDto>>(result);
        }
        [HttpGet("{id}")]
        public async Task<ProgramacionDto> GetProgramacionesById(int id)
        {

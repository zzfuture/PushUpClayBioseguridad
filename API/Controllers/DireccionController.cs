...
namespace API.Controllers
{
    public class DireccionController : BaseController
    {
        ...
        [HttpGet]
        public async Task<IEnumerable<DireccionDto>> GetDirecciones()
        {
            var result = await _unitOfWork.Direcciones.GetAllAsync();
            return _mapper.Map<IEnumerable<DireccionDto>>(result);
        }
        [HttpGet("{id}")]
        public async Task<DireccionDto> GetDireccionesById(int id)
        {
